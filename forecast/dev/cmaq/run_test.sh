...
#> Source the config.cmaq file to set the build environment
 ...
 cd CCTM/scripts
 #source /home/usuario/m/CMAQ/config_cmaq.csh gcc

#> Set General Parameters for Configuring the Simulation
 set VRSN      = v54              #> Code Version - note this must be updated if using ISAM or DDM
 set PROC      = serial #mpi  #             #> serial or mpi
 set MECH      = cb6r5_ae7_aq      #> Mechanism ID
 set APPL      = Argen             #> Application Name (e.g. Gridname)
...
setenv CMAQ_DATA /home/usuario/runs/Argen20oct2022/cmaq

# Set Working, Input, and Output Directories
 setenv WORKDIR ${CMAQ_HOME}/CCTM/scripts          #> Working Directory. Where the runscript is.
 setenv OUTDIR  ${CMAQ_DATA}/output_CCTM_${RUNID}  #> Output Directory
 setenv INPDIR  /home/usuario/runs/Argen20oct2022/cmaq #> Input Directory
...
#> Set Start and End Days for looping
 ...
 set START_DATE = "2022-10-19"     #> beginning date (July 1, 2016)
 set END_DATE   = "2022-10-20"     #> ending date    (July 1, 2016)

#> Set Timestepping Parameters
set STTIME     = 190000            #> beginning GMT time (HHMMSS)
...
setenv GRID_NAME Argentina          #> check GRIDDESC file for GRID_NAME options
...
setenv MG_EMIS_DIAG T
                             #>   output because they occur after scaling.
setenv EMISDIAG_SUM T        #> Print Sum of Emission Rates to Gridded Diagnostic File
...
set LUpath    = $INPDIR/mcip                        #> BELD landuse data for windblown dust model
set SZpath    = $INPDIR/mcip                        #> surf zone file for in-line seaspray emissions
...
# =====================================================================
  ...
  if ($NEW_START == true || $NEW_START == TRUE ) then
     setenv ICFILE ICON_v54_Argen_profile_20221019
  ...
  #> Boundary conditions
  set BCFILE = BCON_v54_Argen_profile_20221019
  ...
  setenv GRID_BDY_2D $METpath/GRIDBDY2D_Argen.nc  # GRID files are static, not day-specific
  setenv GRID_CRO_2D $METpath/GRIDCRO2D_Argen.nc
  setenv GRID_CRO_3D $METpath/GRIDCRO3D_Argen.nc
  setenv GRID_DOT_2D $METpath/GRIDDOT2D_Argen.nc
  setenv MET_CRO_2D $METpath/METCRO2D_Argen.nc
  setenv MET_CRO_3D $METpath/METCRO3D_Argen.nc
  setenv MET_DOT_3D $METpath/METDOT3D_Argen.nc
  setenv MET_BDY_3D $METpath/METBDY3D_Argen.nc
  setenv LUFRAC_CRO $METpath/LUFRAC_CRO_Argen.nc
...
#> Spatial Masks For Emissions Scaling     
  ...
  #setenv N_EMIS_GR 1
  #set EMISfile = out_emis_mole_d01.nc #emis_mole_all_test1_20221019.nc 	##
  ##set EMISfile = emis_mole_all_test_20221019.nc 
  ...
  setenv N_EMIS_GR 0
  set EMISfile  = emis_fires_${YYYYJJJ}_d01.nc 		# emis_fires_2019001_06:00:00_d01.nc
  setenv GR_EMIS_001 /home/usuario/github/CNEA-AQ/finn2cmaq/${EMISfile}
  setenv GR_EMIS_LAB_001 GRIDDED_EMIS
  setenv GR_EM_SYM_DATE_001 F # To change default behaviour please see Users Guide for EMIS_SYM_DATE
  ...
  if ( $CTM_BIOGEMIS_MG == 'Y' ) then                                       
    setenv MEGAN_SOILINP    $OUTDIR/CCTM_MSOILOUT_${RUNID}_${YESTERDAY}.nc  
                             #> Biogenic NO soil input file; ignore if INITI
                             #>                            ; ignore if IGNOR
         #CT3.nc  EF.nc  LDF.nc  LAI3.nc  LAND.nc  NDEP.nc  FERT.nc
         #setenv MEGAN_CTS /home/usuario/github/CNEA-AQ/prepmegan4cmaq/CT3.nc
         #setenv MEGAN_EFS /home/usuario/github/CNEA-AQ/prepmegan4cmaq/EF.nc
         #setenv MEGAN_LDF /home/usuario/github/CNEA-AQ/prepmegan4cmaq/LDF.nc                    
         #setenv MEGAN_LAI /home/usuario/github/CNEA-AQ/prepmegan4cmaq/LAI3.nc
         setenv MEGAN_CTS /home/usuario/data/jeff_cmaq_megan_for_rami/CT3_rami.ncf                    
         setenv MEGAN_EFS /home/usuario/data/jeff_cmaq_megan_for_rami/EFMAP.2019b.rami.ncf
         setenv MEGAN_LDF /home/usuario/data/jeff_cmaq_megan_for_rami/LDF_rami.2019b.ncf                    
         if ($BDSNP_MEGAN == 'Y') then                                      
#CT3.nc  EF.nc  FERT.nc  LAI3.nc  LAND.nc  LDF.nc  NDEP.nc
#/home/usuario/github/CNEA-AQ/prepmegan4cmaq
          #  setenv BDSNPINP    $OUTDIR/CCTM_BDSNPOUT_${RUNID}_${YESTERDAY}.n
          #  setenv BDSNP_FFILE  /home/usuario/github/CNEA-AQ/prepmegan4cmaq/FERT.nc
          #  setenv BDSNP_NFILE  /home/usuario/github/CNEA-AQ/prepmegan4cmaq/NDEP.nc
          #  setenv BDSNP_LFILE  /home/usuario/github/CNEA-AQ/prepmegan4cmaq/LAND.nc
          #  setenv BDSNP_AFILE  /home/usuario/github/CNEA-AQ/prepmegan4cmaq/LAND.nc
          #  setenv BDSNP_NAFILE /home/usuario/github/CNEA-AQ/prepmegan4cmaq/LAND.nc
          #/home/usuario/data/jeff_cmaq_megan_for_rami/BDSNP/
          #ARID_rami.ncf  LANDTYPE_rami.ncf  NDEP_rami.ncf  NONARID_rami.ncf
          setenv BDSNPINP    $OUTDIR/CCTM_BDSNPOUT_${RUNID}_${YESTERDAY}.n
          setenv BDSNP_FFILE /home/usuario/data/jeff_cmaq_megan_for_rami/BDSNP/FERT_rami.ncf          
          setenv BDSNP_NFILE /home/usuario/data/jeff_cmaq_megan_for_rami/BDSNP/NDEP_rami.ncf          
          setenv BDSNP_LFILE /home/usuario/data/jeff_cmaq_megan_for_rami/BDSNP/LANDTYPE_rami.ncf      
          setenv BDSNP_AFILE  /home/usuario/data/jeff_cmaq_megan_for_rami/BDSNP/ARID_rami.ncf          
          setenv BDSNP_NAFILE /home/usuario/data/jeff_cmaq_megan_for_rami/BDSNP/NONARID_rami.ncf      
         endif                 
  endif
...
#RUN!
  ( /usr/bin/time -p mpiexec.mpich -np $NPROCS $BLD/$EXEC ) |& tee buff_${EXECUTION_ID}.txt 
