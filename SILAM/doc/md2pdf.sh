...
pandoc -s -N --template=./templates/mytemplate.tex --variable mainfont="Liberation Sans" --variable sansfont="Liberation Sans Narrow" --variable monofont="Liberation Mono" --variable fontsize=16pt --variable version="${version}" -fmarkdown-implicit_figures --variable title="${title}" --variable subtitle="${subtitle}" --toc --variable geometry:margin=0.6in --pdf-engine=xelatex -s -o ${ouf} ${inf}
