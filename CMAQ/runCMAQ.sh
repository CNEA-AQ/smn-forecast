...
#> Spatial Masks For Emissions Scaling     
  ...
  if ( $CTM_BIOGEMIS_MG == 'Y' ) then                                       
    setenv MEGAN_SOILINP    $OUTDIR/CCTM_MSOILOUT_${RUNID}_${YESTERDAY}.nc  
         ...
         #setenv MEGAN_CTS /home/usuario/github/CNEA-AQ/prepmegan4cmaq/CT3.ncf                    
         setenv MEGAN_EFS /home/usuario/github/CNEA-AQ/prepmegan4cmaq/EFMAP.nc
         ...
         if ($BDSNP_MEGAN == 'Y') then                                      
            ...
            setenv BDSNP_FFILE /home/usuario/data/jeff_cmaq_megan_for_rami/FERT_tceq_12km.ncf          
            setenv BDSNP_NFILE /home/usuario/data/jeff_cmaq_megan_for_rami/NDEP_tceq_12km.ncf          
            setenv BDSNP_LFILE /home/usuario/data/jeff_cmaq_megan_for_rami/LANDTYPE_tceq_12km.ncf      
            setenv BDSNP_AFILE  /home/usuario/data/jeff_cmaq_megan_for_rami/ARID_tceq_12km.ncf          
            setenv BDSNP_NAFILE /home/usuario/data/jeff_cmaq_megan_for_rami/NONARID_tceq_12km.ncf      
         endif                 
  endif
